...
function CohortEditPage() {
	...
	return (
		<div className="relative flex flex-col w-full h-full max-w-3xl p-8 pb-16 mx-auto mt-10 mb-10 bg-white rounded-lg shadow-md CohortEditPage">
			<h3 className="sticky left-0 mb-6 text-2xl font-semibold text-gray-700">
				Edit Cohort
			</h3>

			{showDeleteConfirmation && (
				<div className="absolute top-0 left-0 flex flex-col items-center justify-center h-48 p-4 bg-white border border-gray-300 rounded-md shadow-md w-72">
					<p className="mb-4">
					...
					<div className="flex space-x-4">
						<button
							...
							className="px-3 py-1 font-bold text-white transition duration-150 ease-in-out bg-red-500 rounded hover:bg-red-600"
						>
							Yes
						</button>
						<button
							onClick={() => setShowDeleteConfirmation(false)}
							className="px-3 py-1 font-bold text-black transition duration-150 ease-in-out bg-gray-300 rounded hover:bg-gray-400"
						>
							No
						</button>
					</div>
